...
var sortTable = dc.dataTable('.dc-data-table');
...
d3.json("gitignoredata/mechanical-equipment-pricing.js", function(error, flat_data){
  ...
  sortTable /* dc.dataTable('.dc-data-table', 'chartGroup') */
        .dimension(dateDimension)
        // Data table does not use crossfilter group but rather a closure
        // as a grouping function
        .group(function (d) {
            var format = d3.format('02d');
            return d.field_receive_date_clean.getFullYear() + '/' + format((d.field_receive_date_clean.getMonth() + 1));
        })
